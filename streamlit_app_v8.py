...
def render_overview_page(interessados: pd.DataFrame, comunicacoes: pd.DataFrame, costs_df: pd.DataFrame):
    ...
    render_metric_block(
        ...
        [
            ...
            ("Média contatos antes interesse", format_int(total_interest_contact_metrics["avg_contacts_before_interest"]), "Média de mensagens enviadas antes da data de interesse."),
            ...
            ("Média dias desde última msg", format_int(total_interest_contact_metrics["avg_days_since_last_message"]), "Média de dias entre a última mensagem anterior e a data de interesse."),
            ("Máx. dias desde última msg", format_int(total_interest_contact_metrics["max_days_since_last_message"]), "Maior intervalo em dias entre a última mensagem anterior e a data de interesse."),
        ],
        n_cols=4,
    )
    ...
    render_metric_block(
        ...
        [
            ...
            ("Média contatos antes interesse", format_int(filtered_interest_contact_metrics["avg_contacts_before_interest"]), "Média de mensagens filtradas antes da data de interesse."),
            ...
            ("Média dias desde última msg", format_int(filtered_interest_contact_metrics["avg_days_since_last_message"]), "Média de dias entre a última mensagem filtrada anterior e a data de interesse."),
            ("Máx. dias desde última msg", format_int(filtered_interest_contact_metrics["max_days_since_last_message"]), "Maior intervalo em dias entre a última mensagem filtrada anterior e a data de interesse."),
